...
Please [report bugs](https://github.com/YarnSpinnerTool/YarnSpinner-Console/issues) and open issues generously. Don't be afraid that your idea is silly, or you're reporting a duplicate. We're happy to hear from you. Seriously.
...
* [Fork](https://github.com/YarnSpinnerTool/YarnSpinner-Console/fork) and clone the repository
* Create a new branch: git checkout -b my-branch-name
* Make your changes
* Push to your fork and [submit a pull request](https://github.com/YarnSpinnerTool/YarnSpinner-Console/compare)
